from dataloaders.datasets import cityscapes, coco, combine_dbs, pascal, sbd, her2_region, feiai_region, jcai_region,beiertongbxr_region, qidai_region, taimo_region,prostate_tls, jijie
...
def make_data_loader(args, **kwargs):
    ...
    elif args.dataset == 'jcai_region':
        train_set = jcai_region.JcaiSegmentation(args, split='train')
        val_set = jcai_region.JcaiSegmentation(args, split='val')
        test_set = jcai_region.JcaiSegmentation(args, split='test')
        num_class = train_set.NUM_CLASSES
        train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, **kwargs)
        val_loader = DataLoader(val_set, batch_size=args.batch_size, shuffle=False, **kwargs)
        test_loader = DataLoader(test_set, batch_size=args.batch_size, shuffle=False, **kwargs)
